    ...
    opportunities: [
      {
        ...
        action: "Case evidence: Antwerp's purpose-built bourse opened in 1532, brought European traders together, and set daily prices for goods including grain and spices as well as securities. Availability: this bourse-based service starts only after the 1532 opening. Earlier arrival: learn local measures, language, and guild rules, but defer exchange brokerage until the bourse is operating and grants access. Inference: after securing a recognized role, compare posted terms, inspect samples, and introduce a willing buyer and seller for a stated commission. Do not trade goods whose ownership or labor conditions cannot be verified.",
        category: "enterprise",
        capitalTier: "pocket",
      ...
      },
      {
        ...
        action: "Case evidence: Antwerp's sixteenth-century growth depended partly on the Scheldt and a port receiving overseas goods, including spices. Availability: the source places this traffic in the sixteenth century without one opening date, so act only after local officials and a merchant confirm the named cargo and handling role. Earlier arrival: map lawful warehouses and measures without accepting custody until that confirmation. Inference: contract with a willing merchant to check quantities, arrange lawful storage, and deliver a named non-exploitative cargo to a confirmed city buyer. Charge for the completed handoff rather than betting on the cargo price.",
        category: "enterprise",
        capitalTier: "pocket",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: London's Royal Exchange opened in 1571 as a purpose-built trading center where merchants saw commodity prices, bankruptcies, and ship movements. Availability: the Exchange-based service starts only after the 1571 opening. Earlier arrival: build literacy, local contacts, and knowledge of public shipping notices, but defer Royal Exchange reporting until it opens and grants access. Inference: with a merchant's authorization, copy a requested quotation or arrival notice, confirm it at the Exchange, and deliver it for an agreed fee. Report facts without trading on confidential information.",
        category: "enterprise",
        capitalTier: "pocket",
      ...
      },
      {
        ...
        action: "Case evidence: as control of Scheldt shipping tightened late in the sixteenth century, dues rose and cargoes between Antwerp and the North Sea were transferred twice to smaller vessels. Availability: the specialized two-transfer service applies only after the late sixteenth century controls and transfer rules are in force. Earlier arrival: quote only the lawful handling local authorities actually require, and defer the two-transfer plan. Inference: if authorities and owners consent, quote a bounded loading, checking, and handoff service for ordinary lawful goods. Include every toll and transfer before accepting the job.",
        category: "enterprise",
        capitalTier: "working",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: Amsterdam founded the Exchange Bank in 1609 to value varied coins, support reliable payments, and settle bills of exchange through bank accounts. Availability: Exchange Bank settlement starts only after the bank opens in 1609. Earlier arrival: preserve accepted coin, document ownership and counterparties, and defer this bank-transfer plan until the institution is operating. Inference: for a lawful deal already agreed, use the bank's authorized deposit and transfer process if both counterparties qualify and accept it. The saving is safer settlement, not a speculative return.",
        category: "security",
        capitalTier: "working",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: by 1688 Lloyd's coffee house drew shipowners and captains because it specialized in shipping information. Availability: the documented Lloyd's information venue is available only from its 1688 record onward. Earlier arrival: practice dated public shipping ledgers and seek ordinary messenger work, but defer any Lloyd's-based service until the venue and permission are verified. Inference: with permission, compile public arrival, departure, and vessel-condition reports for a peaceful merchant and charge a stated subscription or delivery fee. Keep observations separate from predictions.",
        category: "enterprise",
        capitalTier: "pocket",
      ...
      },
      {
        ...
        action: "Case evidence: at Lloyd's coffee house, individual underwriters sold insurance to shipowners against a vessel not returning. Availability: the documented Lloyd's placement route is available only from the 1688 coffee-house record onward. Earlier arrival: document cargo ownership, vessel condition, and affordable loss limits, but defer Lloyd's placement until a recognized broker and underwriter are available. Inference: ask a recognized broker to place coverage for a small, peaceful, traceable cargo, disclose the ship's condition, and compare the premium with the loss you can bear. Do not pretend that a policy or underwriting seat is automatically available.",
        category: "security",
        capitalTier: "working",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: after a 1699 Act, river improvements let water-borne goods reach Leeds; merchants could ship cloth through Hull to continental markets. Availability: the freight plan applies only once the post-1699 improvements are open to the stated cargo and a carrier confirms passage. Earlier arrival: inspect tolls and seek a conditional carrier commitment, but defer taking cargo until navigability is confirmed. Inference: in the operating years of this window, contract a small barge movement for a confirmed cloth merchant, include tolls and handling, and settle on documented delivery. The route is evidence of access, not a guaranteed margin.",
        category: "trade",
        capitalTier: "working",
      ...
      },
      {
        ...
        action: "Case evidence: South Sea Company shares rose dramatically in 1720 amid an investment frenzy, then crashed and ruined thousands. Availability: this exit lesson applies to a lawful existing holding before or during the 1720 frenzy; the source does not support buying shares merely to resell them. Earlier arrival: avoid opening the position, or document custody and liquidity for an existing holding while the market remains orderly. Inference: if you arrive holding the shares, sell through a lawful broker before the documented frenzy peaks; otherwise decline the promotion and keep capital in transparent, liquid form. Do not short, spread rumors, or manufacture demand.",
        category: "asset",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: the Bridgewater Canal's first section opened in 1761 to move coal from Worsley to Manchester and became a model for later industrial canals. Availability: canal carriage starts only after the first section opens in 1761. Earlier arrival: inspect the route and negotiate only a conditional shipper or carrier agreement; do not accept cargo before navigation opens. Inference: after obtaining the owner's permission, quote carriage or handling for a confirmed lawful load using available boats and paid crews. Start with one delivery and count tolls, delay, and return capacity.",
        category: "enterprise",
        capitalTier: "working",
      ...
      },
      {
        ...
        action: "Case evidence: Boulton and Watt's 1777 factory engine showed that complex steam equipment required site-specific sizing, locally made parts, installation oversight, and multi-year charges linked to usefulness. Availability: this installation-service case starts with the documented 1777 engine and only where Boulton and Watt authorize work. Earlier arrival: train in lawful general mechanical work and defer this engine-specific service until an authorized project exists. Inference: train under an authorized engineer and offer paid surveying, fitting, or maintenance on a consenting civilian factory installation. Do not copy patented work or claim engineering competence you cannot demonstrate.",
        category: "enterprise",
        capitalTier: "pocket",
