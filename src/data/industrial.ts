    ...
    opportunities: [
      {
        ...
        action: "Case evidence: Joseph-Marie Jacquard developed his loom in 1804-1805; punched cards controlled which warp threads rose and allowed detailed patterns with less supervision. Inference: after training with an authorized workshop, punch and proof a card set for a buyer-approved pattern, charging by the accepted set. Do not copy another designer's pattern or promise that every workshop has adopted the new mechanism.",
        category: "enterprise",
        capitalTier: "pocket",
      ...
      },
      {
        ...
        action: "Case evidence: Fulton's 1807 Hudson voyage demonstrated commercially viable steam propulsion between New York and Albany. Inference: with the operator and wharf owner's approval, coordinate passenger baggage or pre-booked parcels for one stop, using a manifest and a stated handling fee. Do not buy a vessel or assume access to Fulton's monopoly.",
        category: "enterprise",
        capitalTier: "pocket",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: New York authorized Erie Canal construction in 1817 and work began that year on a large public waterway. Inference: supply an approved contractor with a pre-ordered batch of ordinary tools, food, or repair materials from voluntary producers, paid on inspection. Do not claim a public contract, land right, or engineering role without documents.",
        category: "enterprise",
        capitalTier: "working",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: the Erie Canal opened in 1825 and carried timber, farm products, manufactured goods, and merchandise between inland and coastal markets. Inference: arrange one insured, lawful shipment for a named shipper and consignee, earning an agreed coordination fee or disclosed margin. Verify tolls, handling, season, and spoilage before accepting the cargo.",
        category: "trade",
        capitalTier: "working",
  ...
  },
  {
    ...
    opportunities: [
      ...
      },
      {
        ...
        action: "Case evidence: railway speculation peaked in the mid-1840s, many subscribers committed after tiny deposits, and share prices later fell with fortunes lost. Inference: sell any lawfully owned speculative subscription before unpaid calls exceed your liquid capital, or decline new issues whose full commitment you cannot fund. Do not short, spread rumors, or rely on selling to a greater fool.",
        category: "asset",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: Singer's 1851 commercial machine was built for manufacturing trades, while the decade's competing patents led to a patent pool and licensed growth. Inference: with manufacturer authorization, train operators, fit machines, and provide maintenance to a voluntary workshop for a clear fee. Do not copy patented mechanisms or claim that productivity automatically raised workers' pay.",
        category: "enterprise",
        capitalTier: "pocket",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: the successful 1866 transatlantic cable cut message time between Europe and North America from weeks to hours and generated station traffic records. Inference: after operator training and company hiring, transmit or reconcile paid civilian messages under the station's procedures. Charge only approved tariffs or wages and never trade on message contents.",
        category: "enterprise",
        capitalTier: "pocket",
      ...
      },
      {
        ...
        action: "Case evidence: an 1865 Bessemer converter demonstrated a viable way to produce large quantities of affordable steel by blowing air through molten iron. Inference: with metallurgical training and the works' authorization, inspect civilian rails or machine components against an agreed specification. Earn by accepted tests and reject work you cannot safely verify.",
        category: "enterprise",
        capitalTier: "pocket",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: Ford made the Model T available in 1908 as an affordable, simple, durable vehicle and expanded production rapidly. Inference: after manufacturer-recognized training, stock a small set of common lawful parts and provide inspected maintenance to confirmed owners. Start by order; do not claim a dealership, warranty authority, or future sales volume without a contract.",
        category: "enterprise",
        capitalTier: "working",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: Ford introduced the moving automobile assembly line at Highland Park in 1913; narrow timed tasks increased output but could leave cars missing parts and drove worker turnover. Inference: if lawfully hired, perform an agreed civilian quality check at one station and record defects before the vehicle advances. Do not assume employment, ownership, or authority to redesign the line.",
        category: "enterprise",
        capitalTier: "pocket",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: ordinary investors used brokerage houses, investment trusts, and margin loans during the 1920s boom; prices peaked in 1929 and then collapsed. Inference: hold only lawfully purchased, unleveraged securities you understand and reduce exposure when margin-fueled speculation becomes the thesis, exiting before the documented crash rather than trying to identify its exact day. Never short, manipulate prices, or trade on confidential future knowledge.",
        category: "asset",
        capitalTier: "substantial",
      ...
      },
      {
        ...
        action: "Case evidence: radios became a leading consumer product in the 1920s, and by decade's end an estimated large share of American families owned one. Inference: after electrical training, diagnose and repair a confirmed customer's set with approved parts and an up-front estimate. Keep the business in service and lawful equipment; do not manipulate broadcasts or make hidden advertising claims.",
        category: "enterprise",
        capitalTier: "pocket",
    ...
    opportunities: [
      {
        ...
        action: "Case evidence: the Treasury introduced registered, nonmarketable savings bonds in 1935 for small investors, with scheduled redemption values and replacement after loss. Inference: if an authorized agent confirms your eligibility, place only capital you can hold through the stated period into the current Series A-D issue and retain registration evidence. Treat it as conservative savings, not a liquid trading vehicle.",
        category: "security",
        capitalTier: "pocket",
